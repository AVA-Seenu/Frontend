...
export async function getTrailerDetails(searchValue,page,order)
{
    let config =
    {
        url : `https://fl-p-eus-app2.azurewebsites.net/forklift/gettrailerdetails?value=${searchValue}&start=${page}&order=${order}`,
        header:
        {
...
export async function deleteTrailerDetailsById(id)
{
    let config =
    {
        url : `https://fl-p-eus-app2.azurewebsites.net/forklift/deletetrailerdetailsbyid?id=${id}`,
        header:
        {
            "content-type" : "application/json",
        },
...
export async function getServiceCenterData()
{
    let config =
    {
        url : `https://fl-p-eus-app2.azurewebsites.net/forklift/getservicecenterdata`,
        header:
        {
            "content-type" : "application/json",
        },
...
export async function getTrailerDetailsById(id)
{
    let config =
    {
        url : `https://fl-p-eus-app2.azurewebsites.net/forklift/gettrailerdetailsbyid/${id}`,
        header:
        {
            "content-type" : "application/json",
        },
...
export async function insertTrailerDetails(trailerDetails)
{
    let config =
    {
        url : `https://fl-p-eus-app2.azurewebsites.net/forklift/inserttrailerdetails`,
        header:
        {
            "content-type" : "application/json",
        },
...
export async function updateTrailerDetails(trailerDetails)
{
    let config =
    {
        url : `https://fl-p-eus-app2.azurewebsites.net/forklift/updatetrailerdetails`,
        header:
        {
            "content-type" : "application/json",
        },
...
export async function searchTrailerDetails(value)
{
    let config =
    {
        url : `https://fl-p-eus-app2.azurewebsites.net/forklift/searchtrailerdetails?value=${value}`,
        header:
        {
            "content-type" : "application/json",
        },
